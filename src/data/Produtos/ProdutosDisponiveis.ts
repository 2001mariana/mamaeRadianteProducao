...
export const ProdutosDisponiveis: Ebook[] = [
    ...
    },
    {
        ...
        descricao: [
            'Sabe aquele aquecer no peito que dá quando sente um abraço de uma pessoa amada, ou quando reencontra alguém depois de muito tempo e finalmente pode abraçar essa pessoa, está pertinho?',
            'Pois bem é exatamente isso que o Gravidez Radiante vem te ensinar a fazer com o seu bebê, aquece-lo com seu abraço e está pertinho dele e isso tem que ser feito com ele ainda no seu ventre, para que ele já saiba que tem uma mãe desde o momento em que ele surgiu.'
        ],
        tituloBeneficios: ['Ter uma Gravidez Radiante é um caminho sem volta', 'que te proporciona ter:'],
        tituloDepoimentos: 'Veja como a Gravidez Radiante mudou a vida das gestantes',
    ...
    },
    {
        ...
        bonus: {
            ...
            titleBeneficiosBonus: 'Ser uma Mamãe Radiante é um caminho sem volta que te proporciona ter:',
            textoBonusEbookPrincipal: [
               'A Mamãe Radiante é aquela que tem uma gravidez de ouro, diferente de tudo que já foi visto antes, uma Gravidez Radiante. ', 
               'Além disso, ela domina o dom de vestir bem seu bebê com amor e cuidado, deixando-o sempre confortável, protegido do frio e calor e fazendo ele feliz por tê-la como mãe.',
               'E por fim, essa guerreira, sabe nutrir o corpo e alma do seu bebê com o alimento que ele mais precisa na vida, o LEITE MATERNO. Com isso, ela consegue dá a ele a força, sustança e nutrição que todo bebê merece. E proporciona a ele algo lindo, essencial na vida dele, único e pouco conhecido: Amamentação Consciente.'
